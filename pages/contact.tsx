    ...
    >
      ...
      <GridContainer>
        ...
        <Grid className={classes.wrap}>
          <Cell cols={7} colsM={8} className={classes.message}>
            {submitted && (
          ...
          >
            <h5 className={classes.instructions}>
              Edit the message provided or delete it and write your own.
            </h5>
            ...
            <div className={classes.section}>
              <p style={{ margin: 0 }}>
                <a href="mailto:info@payloadcms.com" className={classes.link}>
                  info@payloadcms.com
                </a>
              </p>
            </div>
